...
// ✅ ADDED: винесли client-логіку в окремий компонент
import UnauthorizedClient from '../unauthorized/UnauthorizedClient';

export default function UnauthorizedPage() {
  return (
    // ✅ ADDED: Suspense boundary (закриває помилки типу missing-suspense-with-csr-bailout)
    <Suspense
      fallback={
        <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 text-gray-800 p-6">
