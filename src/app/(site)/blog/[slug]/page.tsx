...
//     const img =
//         p.coverImage ||
//         (siteUrl ? `${siteUrl}/og-default.jpg` : undefined);

//     // пріоритет SEO-полів, потім тайтл/опис
//     const title = p.seoTitle || p.title;
//     const description =
//         p.seoDescription ||
//         p.longDescription ||
//         (p.content ? p.content.slice(0, 220) : '');
...
//                 </Link>
//                 <span className="text-slate-600">/</span>
//                 <span className="font-medium text-amber-700 line-clamp-1">
//                     {p.title}
//                 </span>
//             </nav>

//             {/* Header block */}
//             <header className="rounded-3xl border border-slate-200 bg-gradient-to-br from-slate-50 via-white to-amber-50/60 p-6 sm:p-8 shadow-sm">
...
//                     {p.views != null && (
//                         <span className="inline-flex items-center gap-1 rounded-full bg-slate-300 px-3 py-1 text-[11px] text-slate-900">
//                             👁 {p.views} views
//                         </span>
//                     )}
//                 </div>
...
//                     </div>
//                     <p className="mb-3">
//                         For the full content, continue on the original website.
//                     </p>
//                     <a
//                         href={p.sourceUrl}
//                         target="_blank"
...
//             {/* SEO debug / info block (canonical etc.) */}
