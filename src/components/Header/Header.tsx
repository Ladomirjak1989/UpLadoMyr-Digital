...
// // ЄДИНИЙ клас контейнера сайту (синхронізовано з макетом)
...
//             : 'bg-gradient-to-br from-[#f7f4ea] via-[#e5dfd0] to-[#d4bfaa] py-4',
//         ].join(' ')}
//         // safe-area зверху для iOS
//         style={{ paddingTop: 'env(safe-area-inset-top)' }}
//       >
//         {/* Весь вміст хедера у єдиному контейнері сайту */}
//         <div className={`${CONTAINER_CLASS} flex justify-between items-center`}>
//           {/* Logo & Text */}
//           <div className="flex items-center space-x-3 sm:space-x-4">
//             <div className="relative w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14">
//               <Image
...
//         {/* Mobile overlay */}
//         <div
//           className={`fixed inset-0 z-40 bg-black/40 md:hidden transition-opacity duration-300 ${isOpen ? 'opacity-100 visible' : 'opacity-0 invisible'
//             }`}
//           onClick={() => setIsOpen(false)}
//           aria-hidden={!isOpen}
//         />
...
//             <div className="flex items-center gap-3 mb-6">
//               <div className="relative h-10 w-10 overflow-hidden rounded-full ring-2 ring-[#ffcd00] bg-white">
//                 <Image src="/img/header/logo1.jpg" alt="Logo" fill className="object-contain" sizes="40px" />
//               </div>
//               <div className="flex-1">
//                 <p className="font-semibold text-blue-950 leading-tight">
//                   UpLadoMyr <span className="text-yellow-700">Digital</span>
...
//                     href={item.link}
//                     onClick={() => setIsOpen(false)}
//                     className={`group relative flex items-center justify-between rounded-lg px-3 py-3 transition-all ${isActive(item.link)
//                       ? 'bg-white/80 text-[#1e3a8a] shadow'
//                       : 'hover:bg-white/70 hover:shadow'
//                       }`}
//                   >
//                     <span className="flex items-center gap-3">
//                       <span
//                         className={`h-2 w-2 rounded-full bg-[#1e3a8a] transition-opacity ${isActive(item.link) ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'
//                           }`}
//                       />
//                       {item.text}
//                     </span>
...
//                     <FiChevronRight
//                       className={`text-[#1e3a8a] transition-transform ${isActive(item.link) ? '' : 'group-hover:translate-x-0.5'
//                         }`}
//                     />

//                     <span
//                       className={`absolute left-0 top-1/2 -translate-y-1/2 h-8 w-1 rounded-r bg-[#1e3a8a] transition-opacity ${isActive(item.link) ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'
//                         }`}
//                     />
//                   </Link>
//                 </li>
