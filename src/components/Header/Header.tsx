...
//             />
//           </div>
//           <p className="text-xs sm:text-sm md:text-base lg:text-lg font-medium tracking-wide text-gray-800">
//             <span className="font-bold text-blue-950 font-dmserif">UpLadoMyr</span>{' '}
//             <span className="text-[#deb40a] font-dmserif">Digital</span>{' '}
//             <span className="font-tangerine hidden sm:inline italic text-gray-500">
//               — where ideas come to life in code
...
//               key={item.link}
//               href={`${langPrefix}${item.link}`}
//               className={`relative group transition-all duration-200 ${isActive(`${langPrefix}${item.link}`)
//                   ? 'text-[#1e3a8a] underline underline-offset-4'
//                   : 'hover:text-[#1e3a8a]'
//                 }`}
//             >
...
//       {/* Mobile Menu Overlay */}
//       <div
//         className={`fixed inset-0 bg-black bg-opacity-40 md:hidden transition-opacity duration-300 ease-in-out ${isOpen ? 'opacity-100 visible' : 'opacity-0 invisible'
//           }`}
//         onClick={() => setIsOpen(false)}
//         aria-hidden={!isOpen}
//       ></div>
...
//               <Link
//                 href={`${langPrefix}${item.link}`}
//                 className={`block transition $${isActive(`${langPrefix}${item.link}`)
//                     ? 'text-[#374151] font-bold'
//                     : 'hover:text-[#374151]'
//                   }`}
//                 onClick={() => setIsOpen(false)}
