...
export default function NewsletterSubscribe() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    /* ✅✅✅ ADDED START: optional "submit started" (NOT Lead) */
    track('SubmitApplication', {
      source: 'blog_newsletter_box',
      action: 'submit',
      content_name: 'NewsletterSubscribe',
    });
    /* ✅✅✅ ADDED END */
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        track('Lead', {
          ...
          method: 'email',
          content_name: 'NewsletterSubscribe',
          email_domain: email.trim().split('@')[1] || undefined,
        });
        /* ✅✅✅ ADDED END */
      ...
      /* ✅✅✅ ADDED START: optional error signal */
      track('Contact', {
        source: 'blog_newsletter_box',
        action: 'error',
        content_name: 'NewsletterSubscribe',
    ...
    <>
      <form className="mt-4 flex flex-col gap-3" onSubmit={handleSubmit}>
        ...
        <button
          type="submit"
          disabled={isSending}
          /* ✅✅✅ ADDED START: click tracking on button (optional) */
          onClick={() =>
            track('Contact', {
              source: 'blog_newsletter_box',
