...
//             WebApps
//           </span>{' '}
//           for Self-Employed Professionals (ZZP), Small- and Big Businesses
//         </h1>
...
//       {/* правий info-карточка — ПРИХОВАНО на мобі */}
//       <aside
//         className="
//           hidden md:block
//           absolute bottom-6
...
//       "
//       style={{ backgroundImage: "url('/img/bannerhome/bannerhome.avif')" }}
//       aria-label="UpLadoMyr Digital — Custom Web Solutions"
//     >
//       {/* overlay */}
//       <div className="absolute inset-0 -z-10 bg-black/45 rounded-b-[10px]" />
...
//             Web Applications
//           </span>{' '}
//           — From Business Sites to Scalable Platforms
//         </h1>
...
//             UpLadoMyr Digital
//           </span>
//           , we design and develop clean, secure and high-performance web solutions.
//           Whether you need a professional website or a custom platform with backend architecture
//           and integrations, we deliver structured development, clear communication
//           and production-ready results built to scale.
//         </p>
...
//       >
//         <p className="font-tangerine text-xl sm:text-2xl leading-relaxed text-white/90">
//           From a professional business website to a scalable custom platform —
//           built fast, structured and ready for growth.
//         </p>
