    ...
    return (
        ...
        >
            <div className="relative z-10 flex flex-col justify-between h-full px-4 sm:px-8 lg:px-20 py-10">
                <h2 className="mt-40 sm:mt-48 text-2xl sm:text-3xl lg:text-4xl font-bold text-center lg:text-right text-white"
                    data-aos="fade-down"
                >
                    Contact Us
                </h2>
                ...
                <div className="flex flex-wrap justify-center lg:justify-end gap-4 sm:gap-6 text-sm sm:text-base font-medium mt-10 pt-10">
                    {contactList.map((contact, index) => (
                        ...
                        >
                            <div
                                className="w-10 h-10 sm:w-12 sm:h-12 bg-white rounded-full p-2 sm:p-3 shadow-md border border-yellow-300 group-hover:bg-[#c7a23f] group-hover:text-white hover:shadow-sm transition-transform duration-300 hover:scale-110 text-black flex items-center justify-center"
                            >
                                {contact.icon}
                            </div>
