...
//         <div
//           className={`fixed
//     top-16 right-2             /* менше зміщення на мобілці */
//     sm:top-24 sm:right-6
//     bg-gradient-to-r from-slate-950/95 via-sky-900/95 to-slate-950/95
//     text-white
//     px-3 py-2                  /* менші відступи на мобілці */
//     sm:px-4 sm:py-3
//     rounded-2xl
//     shadow-lg
//     flex items-start justify-between
//     gap-2 sm:gap-3             /* менший gap на мобілці */
//     z-[60]
//     max-w-[88vw] sm:max-w-xs   /* трішки вужчий на мобілці */
//     text-xs sm:text-sm         /* дрібніший текст на мобілці */
