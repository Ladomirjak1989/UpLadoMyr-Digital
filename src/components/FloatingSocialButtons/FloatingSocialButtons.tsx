...
const FloatingSocialButtons: React.FC<FloatingSocialButtonsProps> = ({ isMenuOpen = false }) => {
  ...
  /* ✅✅✅ ADDED START: avoid double firing in dev (Strict Mode) */
  const promoViewFiredRef = useRef(false);
  /* ✅✅✅ ADDED END */
  ...
  /* ✅✅✅ ADDED START: track promo banner impression (once) */
  useEffect(() => {
    if (!mounted) return;
    if (!campaignActive) return;
    if (!showBanner) return;
    if (hideBannerOnScroll) return;
    if (isMenuOpen) return;

    if (promoViewFiredRef.current) return;
    promoViewFiredRef.current = true;

    track('ViewContent', {
      content_name: 'SpringPromoBanner',
      content_type: 'promo',
      campaign: 'spring_10_off_feb_2026',
      discount: '10%',
      min_project_value: 2000,
      source: 'floating_banner_impression',
    });
  }, [mounted, campaignActive, showBanner, hideBannerOnScroll, isMenuOpen]);
  /* ✅✅✅ ADDED END */
  ...
  const handleClose = () => {
    ...
    /* ✅✅✅ ADDED START: track promo dismiss */
    track('CustomizeProduct', {
      action: 'dismiss',
      element: 'spring_promo_banner',
      campaign: 'spring_10_off_feb_2026',
      source: 'close_button',
    });
    /* ✅✅✅ ADDED END */
      ...
      >
        ...
        <div className="relative group" data-aos="fade-up" data-aos-once="true">
          ...
          <a
            ...
            /* ✅✅✅ ADDED START: CTA tracking */
            onClick={() => {
              track('Contact', {
                source: 'floating_social_buttons',
                channel: 'telegram',
                label: 'Telegram',
                href: 'https://t.me/bettinaladomirjak',
                campaign: campaignActive ? 'spring_10_off_feb_2026' : undefined,
              });
            }}
            /* ✅✅✅ ADDED END */
