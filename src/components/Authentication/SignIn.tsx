...
//   // ⬇️ ініціалізація чекбокса з localStorage + логи
//   const [remember, setRemember] = useState<boolean>(() => {
//     const v = typeof window !== 'undefined' ? localStorage.getItem('rememberMe') === 'true' : false;
//     return v;
//   });
//   useEffect(() => {}, []);
...
//     setError('');
//     try {
//       await login(email, password, remember); // редірект зробить AuthContext
