...
//     // відкривати банер із кнопки «Cookie settings» без перезавантаження
//     const onOpen = () => {
//       syncFromSaved();
//       setOpen(true);
//     };
...
//   const onClose = () => {
//     // повертаємо тумблери до попередніх значень і просто закриваємо
...
//     setHasSaved(true); // ✅ зафіксували, що згода існує
//     setOpen(false);
//     // ініціалізацію GA/Meta робиш тут
//   };
...
//   return (
//     <>
//       {/* overlay: затемнення + blur; кліком закриваємо лише якщо згода вже була */}
//       <div
...
//       >
//         <div className="mx-auto m-3 max-w-4xl rounded-2xl border border-yellow-300 bg-white shadow-2xl">
//           {/* header: icon + title (зліва), Close (справа) */}
...
//               {/* кнопка закриття без змін — тільки якщо згода вже була */}
//               {hasSaved && (
//                 <button
//                   type="button"
//                   onClick={onClose}
...
//                     <tr className="bg-white">
//                       <td className="px-3 py-2">
//                         <code className="rounded bg-slate-100 px-1.5 py-0.5">{CONSENT_COOKIE}</code>{' '}
//                         <span className="text-slate-500">/ {BRAND}</span>
//                       </td>
