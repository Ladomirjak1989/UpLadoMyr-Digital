            ...
            <div className="py-5 px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 max-w-7xl mx-auto">
                <div>
                    <h2 className="text-center text-gray-800 mb-8" data-aos="fade-down">
                        ...
                        <div>
                            <span className='font-tangerine text-lg sm:text-xl text-yellow-600 italic'>We never use pre-made templates.</span>
                        </div>
                    </h2>
                    ...
                    {paginatedProjects.map((proj, i) => (
                        ...
                        >
                            ...
                            <div className="p-4 sm:p-6">
                                <h3 className="text-xl font-tangerine font-semibold text-blue-950 mb-2">{proj.title}</h3>
                ...
                {totalPages > 1 && (
                    <div className="flex justify-center mt-10 gap-2 flex-wrap items-center">
                        <button
                            ...
                            className={`px-4 py-1 rounded border text-sm font-medium transition ${currentPage === 1
                        ...
                        {[...Array(totalPages)].map((_, i) => (
                            <button
                                ...
                                className={`px-3 py-1 rounded border text-sm font-medium transition ${currentPage === i + 1
                        ...
                        <button
                            ...
                            className={`px-4 py-1 rounded border text-sm font-medium transition ${currentPage === totalPages
                                ? 'bg-gray-200 text-gray-400 cursor-not-allowed'
                                : 'bg-white text-gray-800 border-gray-300 hover:bg-gray-100'}`}
                        >
                            Next
